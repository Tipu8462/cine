...
$MM_restrictGoTo = "add_categories2.php";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add_categories2")) {
  $insertSQL = sprintf("INSERT INTO categories2 (category_name) VALUES (%s)",
                       GetSQLValueString($_POST['category_name'], "text"));

  mysql_select_db($database_db_connection, $db_connection);
  $Result1 = mysql_query($insertSQL, $db_connection) or die(mysql_error());

  $insertGoTo = "add_categories2.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_db_connection, $db_connection);
$query_add_categories = "SELECT * FROM categories2";
...
mysql_select_db($database_db_connection, $db_connection);
$query_display_categories = "SELECT * FROM categories2";
...
<title>Add Upcoming Category</title>
...
<div id="section">
    ...
    <div id="data_bar">
        ...
        <center><h2>Add Upcoming Categories</h2></center>
          <form id="add_categories" name="add_categories" method="POST" action="add_categories2.php"<?php echo $editFormAction; ?>">
            ...
            <input type="hidden" name="MM_insert" value="add_categories2" />
          </form>
          <center><h2>Upcoming Categories</h2></center>
          <center>
          <h3>
  ...
  <table border="0" align="center" cellpadding="20" cellspacing="20">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" bgcolor="#e71838"><a href="delete_category2.php?category_id=<?php echo $row_display_categories['category_id']; ?>"><input name="Delete" type="button" value="Delete" id="btn" /></a></td>
        <td align="center" bgcolor="#e71838"><a href="update_category2.php?category_id=<?php echo $row_display_categories['category_id']; ?>"><input name="Update" type="button" value="Update" id="btn" /></a></td>
      </tr>
