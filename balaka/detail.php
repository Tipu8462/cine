...
<form id="buyticket" class="form" method="post" action="confirmation.php">
	...
	<tr>
        ...
        <option value="Select Hall" selected="selected" disabled="disabled">Choose Hall</option>
        <option value="Balaka">Star Cineplex</option>
        <option value="Modhumita">Modhumita Cinema</option>
        </select>
        </td>
        </tr>
	<br><br>
	...
	<tr>
        ...
        <option value="#">07/06/2017</option>
        <option value="#">08/06/2017</option>
	<option value="#">09/06/2017</option>
	<option value="#">10/06/2017</option>
	<option value="#">11/06/2017</option>
	<option value="#">12/06/2017</option>
	<option value="#">13/06/2017</option>
        </select>
        </td>
        </tr>
	<br><br>
