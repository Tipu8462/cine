...
<div id="section" style="height:650px !important;">
	...
	<div id="message_bar" style="height:7% !important;">
   	<center><h3>Welcome <?php echo "Owner!!! Now Show your Power"; ?> || <a href="<?php echo $logoutAction ?>"><input name="Logout" type="button" value="Logout" /><a href="index.php"><input name="Home" type="button" value="Home" />
   	</a></h3></center>
        </div>
