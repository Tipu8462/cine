...
mysql_select_db($database_db_connection, $db_connection);
$query_delete_movie = sprintf("SELECT * FROM movies WHERE movie_id = %s", GetSQLValueString($colname_delete_movie, "int"));
