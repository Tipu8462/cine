...
mysql_select_db($database_db_connection, $db_connection);
$query_add_quality = "SELECT * FROM quality2";
...
mysql_select_db($database_db_connection, $db_connection);
$query_display_quality = "SELECT * FROM quality2";
...
<title>Upcoming Movie Quality</title>
...
<div id="section">
    ...
    <div id="data_bar">
        ...
        <center><h2>Add Upcoming Movie Quality</h2></center>
        <center>
        <h2> Start:<?php echo ($startRow_display_quality + 1) ?> Of:<?php echo min($startRow_display_quality + $maxRows_display_quality, $totalRows_display_quality) ?> Total:<?php echo $totalRows_display_quality ?> </h2
        ...
        <center><h2>Upcoming Movie Quality</h2></center>
  ...
  <table border="0" align="center" cellpadding="20" cellspacing="20">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" bgcolor="#e71838"><a href="delete_quality2.php?quality_id=<?php echo $row_display_quality['quality_id']; ?>"><input name="Delete" type="button" value="Delete" id="btn" /></a></td>
        <td align="center" bgcolor="#e71838"><a href="update_quality2.php?quality_id=<?php echo $row_display_quality['quality_id']; ?>"><input name="Update" type="button" value="Update" id="btn" /></a></td>
      </tr>
