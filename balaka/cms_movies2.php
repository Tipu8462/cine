...
$query_cms_display_movies = "SELECT * FROM movies2";
...
if (isset($_GET['totalRows_cms_display_movies'])) {
  $totalRows_cms_display_movies = $_GET['totalRows_cms_display_movies'];
} else {
  ...
  <table border="0" cellpadding="1" cellspacing="1" width="100%" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center"><a href="details4admin2.php?movie_id=<?php echo $row_cms_display_movies['movie_id']; ?>"><input name="Detail" type="button" value="Detail" id="btn" /></a></td>
        <td align="center"><a href="update_movie2.php?movie_id=<?php echo $row_cms_display_movies['movie_id']; ?>" target="_blank"><input name="Update" type="button" value="Update" id="btn" /></a></td>
        <td align="center"><a href="delete_movie2.php?movie_id=<?php echo $row_cms_display_movies['movie_id']; ?>"><input name="Delete" type="button" value="Delete" id="btn" /></a></td>
      </tr>
