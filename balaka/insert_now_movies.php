...
<div id="section">
    ...
    <div id="data_bar">
        ...
        <form name="insert_now_movies" action="insert_now_movies.php" enctype="multipart/form-data" method="post">
        <table width="95%" align="center" cellpadding="1" cellspacing="12">
            <tr>
	...
	<tr>
            ...
            <tr>
                ...
                <td>
                <select name="category_id" id="insert_movie_form">
			...
			<tr>
                ...
                <td>
                <select name="quality_id" id="insert_movie_form">
	...
	<!----------
	    <tr>
            	<td><strong>Movie Trailer</strong></td>
            ...
            <tr>
        <td><strong>Show Date</td>
        <td align="left">
        <input type="text" name="movie_date" 
                placeholder="Enter Movie Date" id="insert_movie_form_keyword">
        </td>
        </tr>

             
             <tr>
        <td><strong>Show Time</td>
        <td align="left">
        <input type="date" name="movie_time" 
                placeholder="Enter Movie Time" id="insert_movie_form_keyword">
...
$movie_trailer_name_only=$_FILES['movie_trailer']['name'];
...
$movie_trailer_name=time().'_'.$_FILES['movie_trailer']['name'];
...
move_uploaded_file($movie_trailer_tmp_name,$uploaded_images_dir.$movie_trailer_name);

$add_movie="INSERT INTO movies
(category_id, quality_id, movie_name, movie_cast, movie_director, 
movie_img1, movie_img2, movie_img3, movie_trailer, movie_desc, movie_date, movie_time, movie_keyword, status) 
VALUES 
('$movie_category','$movie_quality','$movie_name', '$movie_cast', '$movie_director',
'$movie_img1_name','$movie_img2_name','$movie_img3_name', '$movie_trailer_name','$movie_desc', '$movie_date', '$movie_time', '$movie_keyword','$status')";
