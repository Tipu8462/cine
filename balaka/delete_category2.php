...
mysql_select_db($database_db_connection, $db_connection);
$query_delete_category = sprintf("SELECT * FROM categories2 WHERE category_id = %s", GetSQLValueString($colname_delete_category, "int"));
